...
class ServicesModule(BloxoneAnsibleModule):
    def __init__(self, *args, **kwargs):
        super(ServicesModule, self).__init__(*args, **kwargs)
    ...
    def update(self):
        ...
        update_body = self.validate_readonly_on_update(self.existing, update_body, ["pool_id"])
